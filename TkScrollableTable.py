...
if __name__ == "__main__":
    ...
    table = Table(root, ["column A", "column B", "column C", 'column D'], column_minwidths=[None, None, None, None])
    table.pack(padx=10,pady=10)

    table.set_data([   [1,2,3,4],[4,5,6,6], [7,8,9,6], [10,11,12,43], [13,14,15,7],[15,16,18,83], [19,20,21,88], [196,260,261,868]    ])
    table.cell(0,0, " a fdas fasd fasdf asdf asdfasdf asdf asdfa sdfas asd sadf ")
    
    table.insert_row([22,23,24,8])
    table.insert_row([25,26,27,7])
    
    root.update()
    root.geometry("%sx%s"%(root.winfo_reqwidth(),root.winfo_reqheight()-200))
